          ...
          {drawerType && (
            <div className="md:hidden">
              ...
              <m.div
                ...
                className="fixed bottom-0 left-0 right-0 z-[200] min-h-[60vh] max-h-[88vh] rounded-t-[32px] border-t border-white/20 bg-bg-surface/95 backdrop-blur-3xl p-5 shadow-[0_-16px_50px_rgba(0,0,0,0.85),inset_0_1px_0_rgba(255,255,255,0.18)] flex flex-col overflow-hidden"
              >
                      ...
                      <>
                        ...
                        <div className="grid grid-cols-2 gap-2.5">
                          <Button
                            type="button"
                            variant="outline"
                            onClick={() => handleNavClick(isManager ? '/vaults' : '/portfolio')}
                          ...
                          <Button
                            type="button"
                            variant="outline"
                            onClick={() => handleNavClick(isManager ? '/trade' : '/invest')}
