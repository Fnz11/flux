  ...
  ({ className, children, icon, showDots = true, disabled, type = 'button', ...props }, ref) => {
    return (
      ...
      >
        ...
        <div
          className="absolute -inset-px rounded-xl bg-gradient-to-r from-primary-coral via-primary-amber to-primary-gold opacity-95 transition-[clip-path] duration-400 ease-out [clip-path:inset(0_100%_0_0)] group-hover:[clip-path:inset(0_0%_0_0)] pointer-events-none z-0"
          aria-hidden="true"
        />

        {/* Ambient glow highlight */}
        <div
          className="absolute -inset-1 rounded-xl bg-primary-coral/20 blur-md opacity-0 transition-opacity duration-400 group-hover:opacity-100 pointer-events-none z-[-1]"
          aria-hidden="true"
        />
